...
public class Piece {
	...
	private Orientation orientation; //N S W E
	private LinkedList<Orientation> connectors; //Its neighbours
	...
	public Piece(int posY, int posX) {
		this.posX = posX;
		this.posY = posY;
		this.type = PieceType.VOID; //A l etat init la case(j,i) est vide
